    ...
    for (int i = 0; i < lineCount; i++) {
        ...
        if (matchID.find("QUL_") != string::npos) {
            ...
            if (status.find("Unconfirmed") != string::npos) {
                cout << "\nMatch " << matchID << " is still unconfirmed. Cannot enter scores." << endl;
                cout << player1 << " VS " << player2 << endl;
                continue; // Skip to next match without prompting to confirm
            }
            ...
            // Check if either player has withdrawn
            // Check if either player has withdrawn
            bool player1Withdrew = (player1 == "Withdrew");
            bool player2Withdrew = (player2 == "Withdrew");

            if (player1Withdrew || player2Withdrew) {
                // Set scores (3-0 in favor of the player who didn't withdraw)
                int score1 = player1Withdrew ? 0 : 3;
                int score2 = player2Withdrew ? 0 : 3;
                
                // Determine winner (the player who didn't withdraw)
                string winner;
                if (player1Withdrew) {
                    winner = player2;
                } else {
                ...
                cout << "Auto-generated Scores for Withdrawal: " << player1 << " " << score1 << " - " << score2 << " " << player2 << endl;
                cout << "Winner: " << winner << endl;
                ...
                // Record loser info
                string loser = player1Withdrew ? player1 : player2;
                int loserScore = player1Withdrew ? score1 : score2;
                recordLoserInfo(loser, loserScore, matchID);
